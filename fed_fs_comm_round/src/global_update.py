...
class server_avg():
    def __init__(self,
        ...
        """
        dataset[0] = train data
        dataset[1] = test data
        dataset[2] = number of features
        dataset[3] = num of labels
        ...
        for i in range(num_users):
            ...
            user = user_avg(device,id, train,test,self.global_model,
                        self.batch_size,self.learning_rate, self.local_iters)
    ...
    def save_results(self):
        ...
        if not os.path.exists("/proj/sourasb-220503/fed_fs_communication_round/results/"+directory_name):
        # If the directory does not exist, create it
            os.makedirs('/proj/sourasb-220503/fed_fs_communication_round/results/' + directory_name)



        with h5py.File("/proj/sourasb-220503/fed_fs_communication_round/results/" + directory_name + "/" + '{}.h5'.format(file_name), 'w') as hf:
