...
# Example usage:
# results("./fed_fs_communication_round/results/diabetes/")
# input("press")
# results("./fed_fs_communication_round/results/hill-valley/")
# input("press")
# results("./fed_fs_communication_round/results/ionosphere/")
# input("press")
# results("./fed_fs_communication_round/results/KDD99/")
# input("press")
# results("./fed_fs_communication_round/results/segmentation/")
# input("press")
# results("./fed_fs_communication_round/results/vowel/")
# input("press")
results("./fed_fs_communication_round/results/WDBC/")
input("press")
