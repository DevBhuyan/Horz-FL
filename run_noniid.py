...
def single_obj(lftr,
    ...
    print(f"SINGLE-OBJECTIVE GLOBAL FTR SELECTION for {num_ftr} features")
...
def multi_obj(lftr,
              ...
              classifier,
              num_classes, iid_ratio, dataset):
    print(f"MULTI-OBJECTIVE GLOBAL FTR SELECTION for {num_ftr} features")
...
def anova_obj(num_ftr,
              ...
              df_list,
              num_classes, iid_ratio, dataset):
    print(f"ANOVA for {num_ftr} features")
...
def rfe_obj(num_ftr,
            ...
            df_list,
            num_classes, iid_ratio, dataset):
    print(f"RFE for {num_ftr} features")
